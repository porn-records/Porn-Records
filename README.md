...
| File                   | Contents / Purpose                                                                                                                                                                                                                                                                                                                                                  | Used by: | DNS RPZ               | Pi-hole<br>([with wildcard](#pi-hole) support) | Pi-Hole<br>(without wildcard support) | Hosts files           |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | --------------------- | ---------------------------------------------- | ------------------------------------- | --------------------- |

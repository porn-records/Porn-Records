...
[SpyWare](https://mypdns.org/mypdns/support/-/wikis/SpyWare) issues with both domains in
...
[DNS](https://mypdns.org/MypDNS/support/-/wikis/dns/) and how a OS (Operating System) is
doing it's queries over the network protocols, you have of curse updated
your local network with a
[DNS resolver](https://mypdns.org/mypdns/support/-/wikis/dns/DnsResolver) that do support
the [Response Policy zones](https://mypdns.org/MypDNS/support/-/wikis/rpz/) in full, such
...
by [The "NXDOMAIN" Action](https://mypdns.org/mypdns/support/-/wikis/RPZ-record-types#the-nxdomain-action-cname-anchor-nxdomain):
